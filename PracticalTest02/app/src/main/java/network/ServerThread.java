...
//    data
    ...
    public ServerThread(int port) {
        ...
        try {
          ...
          //  setData("Today", new TimeInformation("2018-05-21", "Monday", "+1GMT"));
           // int today = Log.i(Constants.TAG, data.get("Today").getCurrentDateTime());
    ...
    public synchronized void setData(String key, TimeInformation timeInformation) {
        this.data.put(key, timeInformation);
    }
